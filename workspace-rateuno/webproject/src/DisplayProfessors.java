...
@WebServlet("/DisplayProfessors")
public class DisplayProfessors extends HttpServlet implements Info {
   private static final long serialVersionUID = 1L;

   public DisplayProfessors() {
      super();
   }

   protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
      String prof = request.getParameter("prof").trim();
   ...
   void display(List<Data> listData, PrintWriter out) {
      for (Data data : listData) {
         System.out.println("[DBG] " + data.getProfessor() + ", " + data.getCourse());
